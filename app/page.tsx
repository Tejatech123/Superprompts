            ...
            <section className="mb-16">
              ...
              <div className="flex justify-center gap-2 md:gap-4 mb-8">
                <button
                  ...
                  className={`px-4 py-2 md:px-6 md:py-3 rounded-full text-xs md:text-sm font-semibold transition-all duration-200 flex items-center gap-1 md:gap-2 ${selectedDiwaliFilter === "Women"
                ...
                <button
                  ...
                  className={`px-4 py-2 md:px-6 md:py-3 rounded-full text-xs md:text-sm font-semibold transition-all duration-200 flex items-center gap-1 md:gap-2 ${selectedDiwaliFilter === "Men"
