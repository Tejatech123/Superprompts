        ...
        <div className="max-w-4xl mx-auto">
          ...
          <section className="space-y-6 mt-16">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 justify-items-center">
              ...
              {/* Image 4 - Giant Statue in Bangalore */}
              <div className="group relative overflow-hidden border-border bg-card rounded-2xl transition-all duration-300 hover:scale-103 hover:shadow-2xl hover:shadow-accent/20 transform-gpu">
                <div className="aspect-[282.4/370.4] w-[282.4px] overflow-hidden mx-auto">
                  <img
              ...
              {/* Image 6 - Monumental Product City Ad (from Landing) */}
              <div className="group relative overflow-hidden border-border bg-card rounded-2xl transition-all duration-300 hover:scale-103 hover:shadow-2xl hover:shadow-accent/20 transform-gpu">
                <div className="aspect-[282.4/370.4] w-[282.4px] overflow-hidden mx-auto">
                  <img
                    ...
                    loading="lazy"
                    className="w-full h-full object-cover rounded-lg transition-transform duration-300 group-hover:scale-105 cursor-pointer"
                    onClick={() => setPreviewImage("https://lsn12plqor.ufs.sh/f/LXPMWJObUuOwp3zTc6eNu726RMeTXDadHG1zIB3tvw84Ynxh")}
                  />
                </div>
                <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent md:opacity-0 md:group-hover:opacity-100 opacity-100 transition-opacity duration-300" />
                <div className="absolute bottom-0 left-0 right-0 p-4 md:translate-y-full md:group-hover:translate-y-0 translate-y-0 transition-transform duration-300">
                  <h3 className="text-lg font-bold text-white mb-2">Monumental Product City Ad</h3>
                  <p className="text-sm text-white/80 mb-3">Tap to copy prompt</p>
                  <button
                    onClick={() =>
                      copyPromptLandingStyle(
              ...
              {/* Image 7 - Giant Product CGI (from Landing) */}
              <div className="group relative overflow-hidden border-border bg-card rounded-2xl transition-all duration-300 hover:scale-103 hover:shadow-2xl hover:shadow-accent/20 transform-gpu">
                <div className="aspect-[282.4/370.4] w-[282.4px] overflow-hidden mx-auto">
                  <img
                    ...
                    loading="lazy"
                    className="w-full h-full object-cover rounded-lg transition-transform duration-300 group-hover:scale-105 cursor-pointer"
                    onClick={() => setPreviewImage("https://lsn12plqor.ufs.sh/f/LXPMWJObUuOwTr1m2epH8xseo7JY4wrVvp9IzPcy3ZjtRUFM")}
                  />
                </div>
                <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent md:opacity-0 md:group-hover:opacity-100 opacity-100 transition-opacity duration-300" />
                <div className="absolute bottom-0 left-0 right-0 p-4 md:translate-y-full md:group-hover:translate-y-0 translate-y-0 transition-transform duration-300">
                  <h3 className="text-lg font-bold text-white mb-2">Giant Product CGI</h3>
                  <p className="text-sm text-white/80 mb-3">Tap to copy prompt</p>
                  <button
                    onClick={() =>
                      copyPromptLandingStyle(
              ...
              {/* Image 8 - Explosive Motion Ad (from Landing) */}
              <div className="group relative overflow-hidden border-border bg-card rounded-2xl transition-all duration-300 hover:scale-103 hover:shadow-2xl hover:shadow-accent/20 transform-gpu">
                <div className="aspect-[282.4/370.4] w-[282.4px] overflow-hidden mx-auto">
                  <img
                    ...
                    loading="lazy"
                    className="w-full h-full object-cover rounded-lg transition-transform duration-300 group-hover:scale-105 cursor-pointer"
                    onClick={() => setPreviewImage("https://lsn12plqor.ufs.sh/f/LXPMWJObUuOwLZ3fqQGObUuOwQ3JFylTsXkfHctSMIBCxvrD")}
                  />
                </div>
                <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent md:opacity-0 md:group-hover:opacity-100 opacity-100 transition-opacity duration-300" />
                <div className="absolute bottom-0 left-0 right-0 p-4 md:translate-y-full md:group-hover:translate-y-0 translate-y-0 transition-transform duration-300">
                  <h3 className="text-lg font-bold text-white mb-2">Explosive Motion Ad</h3>
                  <p className="text-sm text-white/80 mb-3">Tap to copy prompt</p>
                  <button
                    onClick={() =>
                      copyPromptLandingStyle(
              ...
              {/* Image 9 - Iconic Landmark Takeover (from Landing) */}
              <div className="group relative overflow-hidden border-border bg-card rounded-2xl transition-all duration-300 hover:scale-103 hover:shadow-2xl hover:shadow-accent/20 transform-gpu">
                <div className="aspect-[282.4/370.4] w-[282.4px] overflow-hidden mx-auto">
                  <img
                    ...
                    loading="lazy"
                    className="w-full h-full object-cover rounded-lg transition-transform duration-300 group-hover:scale-105 cursor-pointer"
                    onClick={() => setPreviewImage("https://lsn12plqor.ufs.sh/f/LXPMWJObUuOw6SkmG4R53SnutNYHFlcKhsWkDoeapCyiRLgf")}
                  />
                </div>
                <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent md:opacity-0 md:group-hover:opacity-100 opacity-100 transition-opacity duration-300" />
                <div className="absolute bottom-0 left-0 right-0 p-4 md:translate-y-full md:group-hover:translate-y-0 translate-y-0 transition-transform duration-300">
                  <h3 className="text-lg font-bold text-white mb-2">Iconic Landmark Takeover</h3>
                  <p className="text-sm text-white/80 mb-3">Tap to copy prompt</p>
                  <button
                    onClick={() =>
                      copyPromptLandingStyle(
